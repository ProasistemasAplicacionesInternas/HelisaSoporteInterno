...
class mantenimientos
{
	...
	private $mejora;
	private $costo_mejora;
	private $condicion_actual;
	...
	public function setMejora($mejora): self
	{
		$this->mejora = $mejora;
	...
	public function getCostoMejora()
	{
		return $this->costo_mejora;
	}

	public function setCostoMejora($costo_mejora): self
	{
		$this->costo_mejora = $costo_mejora;
	...
	{
		return $this->condicion_actual;
	}

	public function setCondicionActual($condicion_actual): self
	{
		$this->condicion_actual = $condicion_actual;
