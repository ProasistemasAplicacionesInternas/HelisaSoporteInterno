    ...
    public function restablecerCuenta($restablecer){
      ...
      if($estado ==5 || ($estado ==6 && $intento == 3)){
        ...
        try {               
          ...
          $body .= "</div>";
          $body .= "<a href='https://soporteinfraestructura.helisa.com/infraestructura/app/view/recuperar_cuenta.php?sTz@fg78:rTRsd4=$hoy&f0Rn@fb45f55xxavdff=@/¡d&8thhj45gb/uias@gh=$usuario'><input type='submit' id='boton' style='margin: 7% 0% 0%;;padding: 11px;border-radius: 7px;border: 0;background: #629a88;;color: #fff;box-shadow: 0px 0px 6px #9c9c9c;' value='Restablecer contraseña'></a>";
