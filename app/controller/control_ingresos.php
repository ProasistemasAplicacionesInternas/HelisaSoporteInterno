...
if(isset($_POST['btn-consultarFecha'])){
    ...
    $seleccion=$db->prepare('SELECT  id_intentos, usuario, DATE_FORMAT(fecha,"%d-%m-%Y %H:%i"),cantidad_exitos, cantidad_fallidos,IP FROM intentos_usuarios WHERE fecha BETWEEN :fechaInicial AND :fechaFinal');
    ...
    if(isset($_POST['todo'])){
        ...
        $seleccion=$db->prepare('SELECT  id_intentos, usuario, DATE_FORMAT(fecha,"%d-%m-%Y %H:%i"),cantidad_exitos, cantidad_fallidos,IP FROM intentos_usuarios WHERE usuario=:user');
        ...
        $seleccion=$db->prepare('SELECT  id_intentos, usuario, DATE_FORMAT(fecha,"%d-%m-%Y %H:%i"),cantidad_exitos, cantidad_fallidos,IP FROM intentos_usuarios WHERE usuario=:user AND fecha BETWEEN :fechaIn AND :fechaFin');
