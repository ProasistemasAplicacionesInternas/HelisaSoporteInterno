...
<body>
    ...
    <div class="container">
            ...
            <!--/*------------------@jefferson.correa--------------------*/-->
                    ...
                    <div class="row mt-3  mb-5 col-12">
                        ...
                        <div class="col-6">
                            <a id="cerrar_creacionServidor" class="btn btn-secondary">Cancelar</a>
                        </div>
                    </div>    
            </div>
    ...
    <script>
        $('#serial_servidor').keyup(function(){
            data = "consultaSerial=1&serial=" + $('#serial_servidor').val();
            $.ajax({
                type: "POST",
                ...
                if(respuesta == 1){
                    $.smkAlert({
                        text: "El serial ya se encuentra registrado, verifiquelo.",
                        type: "warning"
                    })
