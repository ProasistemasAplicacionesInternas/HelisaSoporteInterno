...
$id_servidor = $_POST['id_servidorMaquina'];
$nombre_servidor = $_POST['nombre_servidorMaquina'];
?>
<!DOCTYPE html>
<html lang="es">
        ...
        <div class="col-12 ml-5">
            ...
            <!--/*------------------@jefferson.correa--------------------*/-->
                    ...
                    <div class="row" style="display: none;">
                            <input type="text" name="servidor" value=" <?php echo $id_servidor ?>">
                    </div>
                        <div class="panel row ">                       
                            <div class="col-6">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control info" type="text" name="nombre_servidor" id="nombre_servidor" value="<?php echo $nombre_servidor ?>" readonly>
                                </div>
                            </div>
                    ...
                    <div class="panel row ">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                    ...
                                    <input type="text" id="ruta_backup" name="ruta_backup" class="form-control info" autocomplete="off"> 
                            </div>
                        </div>
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                    ...
                                    <input type="text" id="frecuencia_backup" name="frecuencia_backup" class="form-control info" maxlength="40" autocomplete="off" > 
                            </div>
                        </div>
                        <!--<div class="col-4">
                            <div class="form-group">
                    ...
                    <div class="row mt-1 mb-5 col-12" style="margin-left: 45px;">
                        <div class="col-6">
                <!--/*------------------@jefferson.correa--------------------*/-->
                            <button type="submit" class="btn btn-success" id="guardar" name="guardar">Crear Maquina</button>
                        </div>
                <!--/*------------------@jefferson.correa--------------------*/-->
                        <div class="col-6"><a id="cerrar_creacionMaqServidor" class="btn btn-danger">Cancelar</a></div>
                    </div>   
            </div>
