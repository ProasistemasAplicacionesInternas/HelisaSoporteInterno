...
<body>
                    ...
                    <div class="col-2">
                        <label for="">Estado</label>
                            <div class="switch-button">
                                ...
                                <input type="hidden" id="estado_maquina" name="estado_maquina" class="form-control info" maxlength="260" autocomplete="off" value="<?php echo $estadoM ?>" required>
                            </div>
                    </div>
                    <div class="col-6">
    ...
    <script src="../../public/js/checkboxfuction.js"></script>
</body>
