        ...
        <div class="row mt-2">
            ...
            <div class="col">
                    ...
                    <tr>
                        ...
                        <td> 
                            <form action="crear_traslados.php" method="post">
                                <input type="hidden" name="af_responsableB" id="af_responsableB" value="<?php echo $datos->getAf_funcionario();?>">
                                <input type="hidden" name="af_fechaAsignacionB" id="af_fechaAsignacionB" value="<?php echo $datos->getAf_fechaAsignacion();?>">
                                <input type="hidden" name="af_nombreB" id="af_nombreB" value="<?php echo $datos->getAf_nombre();?>">  
                                <input type="hidden" name="af_idB" id="af_idB" value="<?php echo $datos->getAf_id();?>">
                                <input type="hidden" name="af_codigoB" id="af_codigoB" value="<?php echo $datos->getAf_codigo();?>">
                                <input type="hidden" name="af_serialB" id="af_serialB" value="<?php echo $datos->getAf_serial();?>"> 
                                <input type="hidden" name="af_identidadB" id="af_identidadB" value="<?php echo $datos->getIdentidad_funcionario();?>">     
                                <input type="submit" value="Registrar Traslado" name="traslados" class="btn btn-warning">
                            </form>
                        </td>
