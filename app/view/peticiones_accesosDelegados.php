...
<body>
    ...
    <div class="container-fluid" id="infosPeticionesX">
        <div class="row">
            <div class="col-11 mt-4 pl-5 mb-2">
                <h6>Consulta Peticiones Delegadas</h6>
            </div>
            <div class="col">
                    <table class="table table-striped display lenguajeTabla" id="">
                    <thead>
                    ...
                    <?php foreach($peticionesAccesosxDelegado as $datos): ?>
                        
                        <?php if(($datos->getEstado_peticion() == 1 || $datos->getEstado_peticion() == 8 ||  $datos->getEstado_peticion() == 3) && $datos->getAprobado() == 0): ?>
                        <tr>
                            <td>                                
                            ...
                            <td>
                                <?php echo $datos->getFecha_atendido() ?></td>
                            <td>
                                <?php echo $datos->getUsuario_atendio() ?></td>
                            <td style="text-align:center">
                                <?php if($datos->getEstado_peticion() == 1 || $datos->getEstado_peticion() == 3):?>
                                    <form action="app/view/seleccionar_peticionAcceso.php" method="POST" >
