...
$checkResult = $Authenticator->verifyCode($_SESSION['auth_secret'], $_POST['code'], 2);    // 2 = 2*30sec clock tolerance, ESTO DEVUELVE FALSE O TRUE DEPENDENDO DE LA FUNCION

if ((!$checkResult) && ($_POST['noQR'] ==1) ) {
    $_SESSION['failed'] = true;
    header('location: validacionCodigo.php');

} else if((!$checkResult) && (!$_POST['noQR'] ==1) ) {
    $_SESSION['failed'] = true;
    header('location: validacionGoogle.php');
