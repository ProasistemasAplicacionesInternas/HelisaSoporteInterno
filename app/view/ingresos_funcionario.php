...
<body>
    <?php
        ...
        require('../controller/control_ingresos_funcionarios.php');
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-11 mt-4 pl-5 mb-2">
                <h5>Consultas de Ingresos</h5>
            </div>
            <div class="col">
                <table class="table table-striped" id="tabla">
                    <thead>
                        <th style="width:80px;">Nro. Intento</th>
                        <th style="width:40px;">Usuario</th>
                        <th style="width:40px;">Fecha</th>                        
                        <th style="width:40px;">Intentos exitosos</th>
                        <th style="width:40px;">Intentos fallidos</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <?php echo $info->getId_intentos() ?>
                            </td>
                            <td>
                                <?php echo $info->getNombre() ?>
                            </td>
                            <td>
                                <?php echo $info->getUfecha_sistema() ?>
                            </td>
                            <td>
                                <?php
                                echo $exito = $info->getExitos();
                                $exitos += $exito;
                ...
                <?php
                echo '<b>Total de Ingresos Exitosos: </b>',$exitos,'<br>';
                echo '<b>Total de Ingresos Fallidos: </b>',$fallos,'<br>';
                $total = $exitos + $fallos;
                echo '<b>Total de Ingresos: </b>',$total,'<br>';
