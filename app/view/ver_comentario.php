...
<body>
    <?php
            ...
            require_once('../controller/control_comentarios.php');
    ...
    <div class="container-fluid">
        ...
        <div class="row" class="dataConsulta">
            <div class="col-11 mt-4 pl-5 mb-2">
                <h6>Consultas de Observaciones</h6>
            </div>
            <div class="col">
                <table class="table table-striped" id="tabla">
                    <thead>
                        ...
                        <th style="width:40px;  max-width: 50px">Comentario</th>        
                    </thead>
                    <tbody>
                        <?php foreach($listaComentario as $datos): ?>
                        <tr>
                           <td>           
