...
<html lang="es">
    ...
    <header class="container-fluid">            
        ...
        <div class="container">
            ...
            <div class="col-12" id="valida-div" style="width: 22%;text-align: center;float: right;margin: 3% 9% 0% -24%;    border: 1px solid #d9007f;padding: 13px;border-radius: 16px;box-shadow: 0px 0px 5px #bfbfbf;display: none">
           ...
           <form action="../controller/controlador_funcionarios.php" method="post">
              <div class="row restablecer">
                    ...
                    <div class="row mt-3 mb-5 col-12" id="botones-restablecer">
                        <div class="col-2">
                            <button type="button" class="btn btn-info" id="restablecer-cuenta" name="restablecer-cuentaF">Guardar</button>
                        </div>                      
                    </div>
            </div>
        </form>
        ...
        <script src="../../public/js/es.min.js"></script>
        <script src="../../public/js/validacion_funcionario.js"></script>
        <script src="../../public/js/validar_recuperacion.js?b54"></script>
        <script src="../../public/js/valida_contrasenaF.js"></script>
        <script src="../../public/js/bloqueoTeclas.js"></script>
