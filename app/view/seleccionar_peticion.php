        ...
        <div class="row">
            ...
            <div class="col-12 ml-5">
                <div class="form-group">
                    <form action="../controller/controlador_peticion.php" class="form-group mt-3" method="post">
                        <div class="col-12">
                            <div class="row">
                                <div class="col-4">
                            ...
                            <div class="row">
                                <div class="col-12 mt-2">
                                    <label for="">Estado</label>
                                        <select name="p_estado" id="p_estado" required>
                            ...
                            <div class="row">
                                <div class="col-3">
                                    <input type="submit" value="Guardar" id="aceptar" name="aceptar" class="btn btn-primary  mt-3" >
                                </div>                              
                           </div>
