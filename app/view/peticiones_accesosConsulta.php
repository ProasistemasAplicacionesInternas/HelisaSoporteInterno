                ...
                <div class="col">
                        ...
                        <?php foreach($peticionesAccesosxUsuario as $datosU): ?>
                            <tr>
                                ...
                                <td>
                                    <?php switch($datosU->getTipo()){case 0:echo "Modificacion";break;case 1:echo "Activacion";break;case 2: echo "Inactivacion";break;case 3: echo "Novedades";break;case 4: echo "Reactivacion";break;Default:echo "Modificacion";} ?></td> 
                                <td>
                                ...
                                <td align="center"><i 
                                <?php if($datosU->getEstado_peticion() != 2){
                                           echo 'class="fa fa-circle-o-notch" title="En proceso"';
                                        }else if($datosU->getRevisado() == 0){
                                            echo 'class="fa fa-circle-o" title="Finalizado sin Aceptar"';
                                        }else if($datosU->getRevisado() == 1){
                                             echo 'class="fa fa-circle" title="Finalizado."';
                                        }
                                ?>
                                </i>
                                </td>
