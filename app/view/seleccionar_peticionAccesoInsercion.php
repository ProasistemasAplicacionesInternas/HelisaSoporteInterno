                        ...
                        <!-- <div class="col-12"> -->
                            <div class="row mb-3">
                                <div class="col-3">
                                    ...
                                    <input type="text" id="id_peticion" name="id_peticion" class="form-control" value="<?php echo $peticion;?>" readonly>
                                </div>

                                <div class="col-3">
                                    <label>Fecha Solicitud</label>
                                    <input type="text" id="fecha_creacion" name="fecha_creacion" class="form-control" value="<?php echo  $fecha_creacion;?>" readonly>
                                </div> 
                            </div>
                            ...
                            <div class="row">
                                <div class="col-3">
                                    <label>Usuario </label>
                                    <input type="text" id="usuario_creacion" name="usuario_creacion" class="form-control" value="<?php echo  $usuario_creacion;?>" readonly> 
                                </div>

                                <div class="col-3">
                                    <label>Fecha registro usuario</label>
                                    <input type="text" id="fecha_registro" name="fecha_registro" class="form-control" value="<?php echo $f_fechaRegistro;?>"  readonly>
                                </div> 
                            </div>
                            ...
                            <div class="row mb-2">
                                <div class="col-3">
                                    ...
                                    <input type="text" id="p_correo" name="p_correo" class="form-control" value="<?php echo $f_correo;?>" title="<?=$f_correo?>" readonly>
                                </div>

                                <div class="col-3">
                                    <label>Identificacion</label>
                                    <input type="text" id="p_identificacion" name="p_identifiacion" class="form-control" value="<?php echo $f_identificacion;?>" readonly>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-3">
                                    ...
                                    <input type="text" id="p_correo2" name="p_correo2" class="form-control" value="<?php echo $f_correo2;?>" title="<?=$f_correo?>" readonly>
                                </div>

                                <div class="col-3">
                                    <label>Nombre</label>
                                    <input type="text" id="p_nombre" name="p_nombre" class="form-control" value="<?php echo $f_nombre;?>"  title="<?=$f_nombre?>" readonly>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-12 mt-2">
                                    <div>
                                        ...
                                        <textarea name="conclusionesAdd" id="conclusionesAdd" class="form-control col-6 data" placeholder="Campo No Obligatorio"></textarea>                                        
                                </div>
                            </div>
                                        ...
                                        <?php 
                                            ...
                                            foreach($plataformas as $listado):
                                                for($x=0; $x<$numElement;$x++):
                                                    ...
                                                    <div class="row mt-2">
                                                        <div class="col-sm-4">
                                                            <input type="hidden" class="form-control" name="plataforma<?php echo $numeracion;?>"  value="<?php echo $listado['id_plataforma'];?>" >
                                                            <input type="text" title="<?=$listado['descripcion'];?>" class="form-control" value="<?php echo $listado['descripcion'];?>" readonly>
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <input type="text" class="form-control" autocomplete="off" id="nombre_usuario<?php echo $numeracion;?>" name="nombre_usuario<?php echo $numeracion;?>" placeholder="Nombre" required>
                                                        </div>
                                                        <div class="col-sm-2">
                                                            <input type="password" class="form-control" id="clave<?php echo $numeracion;?>" name="clave<?php echo $numeracion;?>" placeholder="Password" required>
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <select class="form-control" id="estado<?php echo $numeracion;?>" name="estado<?php echo $numeracion;?>"  onchange="aprobacionPlataformas('<?php echo $numeracion;?>');">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <input type="hidden" value="<?php echo $plataformasPeticion;?>" name="plataformasPeticion">
                                    <input type="hidden" value="<?php echo $numeracion;?>" name="numeracion">
                                    <input type="hidden" value="<?php echo $f_identificacion;?>" id="f_identificacion" name="f_identificacion">
                                    <input type="submit" value="Guardar"  name="guardarInserciones" class="btn btn-primary mt-3" >  
                                    <input class="btn btn-danger mt-3" style="max-width:90px;" value="Liberar" onclick="liberarPeticion(<?php echo $peticion;?>);">
                                </div>    
                           </div>
