                        ...
                        <tbody>
                            <?php foreach ($consultarAccesosPlataformas as $listado) : ?>
                                <?php if ($listado->getEstado() == 5) : ?>
                                    <tr>
                                        <td style="max-width:5vh"><span><?= $listado->getPlataformaDescripcion() ?></spam>
                                        </td>
                                        <td style="max-width:7vh;overflow:hidden"><span><?= $listado->getUsuario() ?> </spam>
                                        </td>
                                        <td><span><?= $listado->getFecha_registro() ?> </spam>
                                        </td>
                                    </tr>
                                <?php endif; ?>
                            <?php endforeach; ?>
                ...
                <form class="mt-3" id="modificaFuncionario">
                    ...
                    <div id="funcionarioTranspaso" class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <select class="form-control info" id="funcionario_traslado" name="funcionario_traslado" value="<?php echo $af_funcionario ?>">
                                ...
                                <select class="form-control info" id="f_departamentosInt" name="f_departamentosInt" value="<?php echo $f_departamentoInterno ?>" required>
                                    ...
                                    <?php foreach ($departamentosInternos as $listado_departamentos) : ?>
                                        <?php if ($listado_departamentos['estado'] == 5) : ?>
                                            <option value='<?php echo $listado_departamentos['id_departamento']; ?>' <?php if ($datosListados['id_departamento'] == $listado_departamentos['id_departamento']) {
                                                                                                                        echo 'selected';
                                                                                                                    } ?>><?php echo $listado_departamentos['descripcion']; ?></option>
                                        <?php endif; ?>
                                    <?php endforeach ?>
                                </select>
                            </div>
                                ...
                                <select class="form-control info" id="f_area" name="f_area" required>
                                    ...
                                    <?php foreach ($listado_areas as $area) : ?>
                                        <?php if ($area['estado'] == 5 && $area['estado_departamento'] == 5) : ?>
                                            <option value='<?php echo $area["id_area"]; ?>' class="areaCP areaCS<?php echo $area['id_departamento']; ?>" <?php if ($codigoArea == $area["id_area"]) {
                                                                                                                                                            echo 'selected';
                                                                                                                                                        } ?>><?php echo $area['descripcion']; ?></option>
                                ...
                                <select class="form-control info" id="f_cargo" name="f_cargo" required>
                                    ...
                                    <?php foreach ($listado_cargos as $cargo) : ?>
                                        <?php if ($cargo['estado'] == 5 && $cargo['estado_area'] == 5 && $cargo['estado_departamento'] == 5) : ?>
                                            <option value='<?php echo $cargo['id_cargo']; ?>' class="cargoCP cargoCS<?php echo $cargo['id_area']; ?>" <?php if ($codigoCargo == $cargo['id_cargo']) {
                                                                                                                                                        echo 'selected';
                    ...
                    <div class="row">
                        <div class="col-7">
                            <div class="form-group">
                                <label>Usuario</label>
                                <input type="text" id="f_usuario" name="f_usuario" class="form-control info" maxlength="50" autocomplete="off" value="<?= $f_usuario ?>" <?php if ($_SESSION['id_roles'] != 1 && $_SESSION['id_roles'] != 7) {
                                                                                                                                                                                echo "readoly";
                                                                                                                                                                            } ?>>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-4"> <button type="button" class="mt-5 btn btn-success" id="btn-guardarModif" name="btn-guardarModif" style="height:33.5px;">Guardar</button></div>
                        <div class="col-3"> <a id="cerrar_modificacion" class="mt-5 btn btn-secondary" style="height:33.5px;">Cancelar</a> </div>
