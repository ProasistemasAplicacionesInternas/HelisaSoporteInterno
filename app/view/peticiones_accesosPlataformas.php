                    ...
                    <?php foreach($peticionesAccesosxPlataforma as $datos): ?>
                        <tr>
                            ...
                            <?php switch($datos->getTipo()){
                                ...
                                Default:echo "Modificacion";} ?></td>
                            <td>
                                <?php echo $datos->getDescripcion() ?></td> 
                            <td>
                                <?php echo $datos->getEstado_descripcion() ?></td> 
                            <td>
                                <?php if($datos->getEstado_peticion() == 8){ echo $datos->getFecha_atendido();} ?></td>
                            <td>
                                <?php if($datos->getEstado_peticion() == 8){ echo $datos->getUsuario_atendio();} ?></td>
