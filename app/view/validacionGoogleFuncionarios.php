...
$qrCodeUrl = $Authenticator->getQR('HelisaPeticionesTecnología', $_SESSION['auth_secretF']); //RANDOM
...
<body  class="bg">
    <div class="container">
        <div class="row">
                ...
                <h1>Autenticación de QR Funcionarios</h1>
        </div>   
    </div>
    <div class="container1 center">
        <div class="row">
            ...
            <div class="col">
                <form action="checkFuncionarios.php" method="post">
