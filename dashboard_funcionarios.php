        ...
        <div class="row">
            ...
            <div class="col-2 mt-3 navega">
                <nav>
                    ...
                    <a id="validationBoveda" ><img src="public/img/soporte.png" alt="" class="ml-3" onclick:><!-- data-toggle="modal"  data-target="#claveBovedaModal" target="_blank" id='modalBovedaOpen'  // abre la modal con html-->
                        <span>Boveda</span>
                    </a>

                    <?php if ($_SESSION['rol']==2 ) {echo '<a href="#" id="control_actividades_administracion"><img src="public/img/cartera.png" alt="" class="ml-3">Control Actividades</a>';}?>
                    
                    <div class="dropdown">
                            <a class=" dropdown-toggle" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <img src="public/img/consultas.png" class="ml-3"><span>Consultar Solicitudes</span></a>
                    ...
                    <div class="dropdown">
                        <a class=" dropdown-toggle" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fas fa-sitemap fa-2x ml-4 mr-2" style="color:#808080;"></i><span>Gestion De Procesos</span></a>
